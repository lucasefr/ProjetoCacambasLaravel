...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            <input type="text" name="TelefoneFixo" class="form-control" placeholder="Tel Fixo...">
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <label for="TelefoneComercial">Telefone Comercial</label>
            <input type="text" name="TelefoneComercial" class="form-control" placeholder="Tel Comercial...">
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <label for="TelefoneCelular">Telefone Celular</label>
            <input type="text" name="TelefoneCelular" class="form-control" placeholder="Tel Celular...">
        </div>
       <div class="form-group col-lg-10 col-md-10 col-sm-10 col-xs-12">
