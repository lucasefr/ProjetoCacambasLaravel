...
<html>
  <head>
    ...
    <title>Sistema de Logistica de Caçambas de Entulho - Lucas Emanuel</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>LLE</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>LLE - Vendas</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Lucas Emanuel</span>
                </a>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Caçambas</h3>
